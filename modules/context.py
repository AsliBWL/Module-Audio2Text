...
from modules.audio_capture import MicrophoneSource
from modules.vad_detector import SileroVADDetector
from modules.speech_recognizer import FasterWhisperRecognizer
from modules.speech_builder import SpeechBuilder
from modules.session_context import SessionContext

# --------------------------------------------------------------------------------------------
# ------------------------------------ НАЧАЛО НОВОГО КОДА ------------------------------------
# --------------------------------------------------------------------------------------------
from modules.speech_recognizer import RemoteWhisperRecognizer
# --------------------------------------------------------------------------------------------
# ------------------------------------- КОНЕЦ НОВОГО КОДА ------------------------------------
# --------------------------------------------------------------------------------------------
...
class Context:
    ...
    def __init__(self, whisper_model_version: str = "small",
        ...
        # --------------------------------------------------------------------------------------------
        # Создаем распознаватель речи (преобразует аудио в текст)
        self.recognizer = RemoteWhisperRecognizer(
            self.config,
            server_host="192.168.1.100"  # ← IP-адрес ПК с GPU
        )
        # --------------------------------------------------------------------------------------------
        # ------------------------------------- КОНЕЦ НОВОГО КОДА ------------------------------------
        # --------------------------------------------------------------------------------------------
